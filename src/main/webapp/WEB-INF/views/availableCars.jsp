...
Hey ${username}, here you are the available cars from <fmt:formatDate type="date" value="${startDate}"/> to
...
<table class="table table-dark">
    ...
    <c:forEach items="${availableCars}" var="car">
        <tr>
            ...
            <td><form:form action="${pageContext.request.contextPath}/booking/new" method="post"
